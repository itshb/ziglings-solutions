const std = @import("std"); // std == struct

const Character = struct { gold: u32 = 0, health: u8 = 100, experience: u32 = 0 };
...
fn levelUp(character_access: *Character, xp: u32) void { // parameters are always immutable
